...
import com.github.tddts.evetrader.context.events.SearchStatusEvent;
...
public class SendSearchEventsAnnotationAspect {
  ...
  @Around("@annotation(com.github.tddts.evetrader.config.spring.annotations.SendSearchEvents)")
