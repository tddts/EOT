...
public class MapRegion implements Serializable {
  ...
  public String toString() {
    return "MapRegion{" + "factionID=[" + factionID + "], radius=[" + radius + "], regionID=[" + regionID + "], regionName=[" + regionName + "], x=[" + x + "], xMax=[" + xMax + "], xMin=[" + xMin + "], y=[" + y + "], yMax=[" + yMax + "], yMin=[" + yMin + "], z=[" + z + "], zMax=[" + zMax + "], zMin=[" + zMin + "]}";
  }
}