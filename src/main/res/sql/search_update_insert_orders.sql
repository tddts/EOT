INSERT INTO TMP_SELL_ORDERS (ORDER_ID, LOCATION_ID, LOCATION_SECURITY, PRICE, VOLUME,MIN_VOLUME, TYPE_ID)
...
INSERT INTO TMP_BUY_ORDERS (ORDER_ID, LOCATION_ID, LOCATION_SECURITY, PRICE, VOLUME, MIN_VOLUME, TYPE_ID)
SELECT ORDER_ID, LOCATION_ID, TMP_STATIONS.SECURITY_STATUS, PRICE, VOLUME_REMAIN, MIN_VOLUME, CACHED_ORDER.TYPE_ID
	FROM CACHED_ORDER
	INNER JOIN TMP_STATIONS
	ON TMP_STATIONS.STATION_ID = CACHED_ORDER.LOCATION_ID
